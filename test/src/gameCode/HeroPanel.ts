...
class EquipmentMap {
	...
	head:engine.Bitmap;
	neck:engine.Bitmap;
	shoulder:engine.Bitmap;
	body:engine.Bitmap;
	
	weapon:engine.Bitmap;
	shield:engine.Bitmap;
...
class HeroInfoPanel extends engine.DisplayObjectContainer{
	...
	maxHp_Textfield:engine.TextField;
	maxMp_Textfield:engine.TextField;

	hp_Textfield:engine.TextField;
	mp_Textfield:engine.TextField;
...
class HeroPanel extends engine.DisplayObjectContainer{
	...
	onTapWeapon(e:engine.TouchEvent) {
		console.log("weapon");	
	...
	onTapShield(e:engine.TouchEvent) {
		console.log("shield");	
