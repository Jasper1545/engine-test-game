...
class CommandService {
	...
	private gameScence:engine.DisplayObjectContainer;
	private infoScence:engine.DisplayObjectContainer;
	...
	private changeToGameButton:engine.DisplayObjectContainer;
	private changeToInfoButton:engine.DisplayObjectContainer;


	public constructor(stage:engine.DisplayObjectContainer,gameScence:engine.DisplayObjectContainer,infoScence:engine.DisplayObjectContainer,map:GameMap,player:Player,npcList:NPC[],monsterList:Monster[],dialoguePanel:DialoguePanel,commandList:CommandList) {
	...
	public changeToGameScence(e:any){
	...
	public changeToInfoScence(e:any){
	...
	public onTouch(e:MouseEvent) {
		var x:number = Math.floor(e.offsetX/64);
		var y:number =  Math.floor(e.offsetY/64);
